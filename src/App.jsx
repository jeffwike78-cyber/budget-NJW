...
function App() {
  ...
  const txActions = { recategorize, setExcluded, setBusiness, setTaxCategory, splitTransaction, deleteTransaction };
    ...
    <div className="app-shell">
      ...
      <div className="app-body">
        ...
        <main className="app-main">
          ...
          {view === 'sinking' && (
            <SinkingFunds budgetState={budgetState} setBudgetState={setBudgetState} transactions={transactions} {...txActions} />
          )}
          {view === 'reports' && (
            <TaxReport
              budgetState={budgetState}
